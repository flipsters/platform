    ...
    */
    public function getImageCarouselAttribute()
    {
        if (!is_null($this->cover)) {
            ...
            return 'https://swapcdn.glitch.me/swapifier/assets/11.0.0/img/no_cover_carousel.jpg';
        }
    }
    ...
    */
    public function getImageSquareTinyAttribute()
    {
        if (!is_null($this->cover)) {
            ...
            return 'https://swapcdn.glitch.me/swapifier/assets/11.0.0/img/no_cover.jpg';
        }
    }
