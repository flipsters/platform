    ...
    */
    public function getImageCarouselAttribute()
    {
        if (!is_null($this->cover)) {
            ...
            return 'https://cdn.jsdelivr.net/npm/swapifier@1.0.0-swap/img/no_cover_carousel.jpg';
        }
    }
    ...
    */
    public function getImageSquareTinyAttribute()
    {
        if (!is_null($this->cover)) {
            ...
            return 'https://cdn.jsdelivr.net/npm/swapifier@1.0.0-swap/img/no_cover.jpg';
        }
    }
