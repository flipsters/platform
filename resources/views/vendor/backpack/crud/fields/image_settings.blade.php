  <div class="form-group col-md-12 image" data-preview="#{{ $field['name'] }}" data-aspectRatio="{{ isset($field['aspect_ratio']) ? $field['aspect_ratio'] : 0 }}" data-crop="{{ isset($field['crop']) ? $field['crop'] : false }}" @include('crud::inc.field_wrapper_attributes')>
    ...
    <div class="row">
        <div class="col-sm-6" @if($field['name'] == 'logo' || $field['name'] == 'watermark') style="margin-bottom: 20px; background-color: #222121 !important; padding: 20px; border-radius: 5px;" @endif>
            <img id="mainImage" src="{{ trans('general.cdnurl') }}img/logo.png">
        </div>
                ...
                $('.form-group.image').each(function(index){
                    ...
                    if(crop){
                        ...
                        $remove.click(function() {
                            ...
                            $mainImage.attr('src','{{$field['value']}}');
                            $hiddenImage.val('{{$field['value']}}');
                            $rotateLeft.hide();
                            $rotateRight.hide();
                            $zoomIn.hide();
                            $zoomOut.hide();
