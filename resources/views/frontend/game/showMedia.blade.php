      ...
      @if($video->youtube_id !== 0 )
        <div class="overlay hvr-grow-shadow2 b-r">
          <a class="video-gallery" href="https://www.youtube.com/watch?v={{ $video->youtube_id }}" data-effect="mfp-zoom-in">
            ...
            <div class="imgDescription"><div class="valign"><i class="fa fa-youtube-play" aria-hidden="true"></i></div></div>
            <div class="time"><i class="fa fa-clock-o" aria-hidden="true"></i> {{ gmdate("i:s", $video->length_seconds) }} </div>
