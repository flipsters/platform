...
<div style="margin-bottom: 20px; font-size: 24px; color: #fff; font-weight: 700; "><i class="fa fa-gamepad" aria-hidden="true"></i> {{ trans('games.overview.all_games') }}</div>
          ...
          <a href="{{ $game->url_slug }}">
            ...
            <div class="ribbon ribbon-clip ribbon-bottom ribbon-dark">
              <div class="ribbon-inner">
                <span class="currency"><i class="fa fa-tags"></i></span>
                <span class="price">{{$game->listingsCount}}</span>
              </div>
            </div>
            @endif
