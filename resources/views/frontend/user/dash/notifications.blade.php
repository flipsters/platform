...
@section('subheader')
  ...
  <div class="subheader {{ $user->unreadNotifications()->count() > 0 ? 'tabs' : '' }}">
    ...
    <div class="content">
      <span class="title"><i class="fa fa-bell style="color:#ff9d34"></i> {{ trans('notifications.title') }}</span>
    </div>
...
@section('content')
  ...
  @forelse($user->notifications()->paginate(20) as $notification)
    @include('frontend.notifications.' . snake_case(class_basename($notification->type)))
  @empty
