          ...
          <div class="panel-body padding-40">
            ...
            <form method="post" id="loginFormFull">
              ...
              <div class="form-group clearfix">
                <div class="checkbox-custom checkbox-default checkbox-inline pull-left">
                  <input name="remember" id="remember_full" type="checkbox" />
                  <label for="remember_full">{{ trans('auth.remember_me') }}</label>
                </div>
                {{-- Reset password --}}
                <a data-dismiss="modal" data-toggle="modal" href="#ForgetModal" class="pull-right">{{ trans('auth.password_forgot') }}</a>
              </div>
              {{-- Login button --}}
